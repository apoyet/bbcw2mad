class KnobObj():
    ...
    def define_q4_ir1_knob_b2(self, wire_ir1):
        ...
        self.mad_inst.input(f'''
        kq4.l1b2 := -1.7733578726803535e-08*(on_{wire_ir1.name}*I_{wire_ir1.name}/{wire_ir1.y_pos**2}) + ({kq4_l1_0});
        kq4.r1b2 := -6.420905252157302e-08*(on_{wire_ir1.name}*I_{wire_ir1.name}/{wire_ir1.y_pos**2}) + ({kq4_r1_0});
        ''')
    ...
    def define_q4_ir5_knob_b2(self, wire_ir5):
        ...
        self.mad_inst.input(f'''
        kq4.l5b2 := 8.949783238801728e-09*(on_{wire_ir5.name}*I_{wire_ir5.name}/{wire_ir5.x_pos**2}) + ({kq4_l5_0});
        kq4.r5b2 := 3.49450216922294e-08*(on_{wire_ir5.name}*I_{wire_ir5.name}/{wire_ir5.x_pos**2}) + ({kq4_r5_0});
        ''')
